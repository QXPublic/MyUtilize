【教程】使用AWS Lambda 监控 AWLightsail 流量，超额自动关机，每日流量通知

免责声明：该教程由[亚马逊官方博客链接](https://aws.amazon.com/cn/blogs/china/monitor-amazon-lightsail-data-traffic-using-lambda/)，记录了下自己搭建并改造的过程，并不保证该方式100%可以解决问题，需要自行验证。
...
5、如果流量超出当前计费周期的配额的95%，并关闭对应的 Lightsail 实例。
